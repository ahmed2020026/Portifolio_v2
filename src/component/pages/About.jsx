            ...
            <div className="container mt-10">
                <div className="About-Content grid grid-cols-1 text-center md:text-left md:grid-cols-3 md:gap-12">
                    <div className="about-image text-center md:text-left mb-10 w-11/12 mx-auto">
                        <img src={image} alt="" className="max-w-full rounded-xl" />
                    </div>
                    <div className="About-info col-span-2">
                        ...
                        <a href="#" className="px-3 py-2 bg-green-600 text-white mt-5 rounded inline-block hover:bg-green-800 transition-all">DownLoad CV</a>
                    </div>
                </div>
            </div>
        </>
