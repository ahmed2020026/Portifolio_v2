            ...
            <section id="Hero" className="py-30 min-h-dvh flex items-center">
                <div className="container text-white">
                    <div className="hero text-center">
                        <p className="text-green-600" data-aos="fade-up" data-aos-duration="1500" data-aos-delay='200'>Hello I'm</p>
                        <h1 className="text-3xl md:text-5xl font-bold" data-aos="fade-up" data-aos-duration="1500" data-aos-delay='400'>Ahmed Samir Mustafa</h1>
                        <h2 className="my-3 font-semibold text-base md:text-2xl" data-aos="fade-up" data-aos-duration="1500" data-aos-delay='600'>I'm Front-End Developer | React</h2>
                        <div className="info text-gray-400" data-aos="fade-up" data-aos-duration="1500" data-aos-delay='800'>
                            <p>I create responsive and interactive web interfaces using modern technologies like React, Tailwind CSS, and Bootstrap.</p>
                        </div>
                        <div className="btns mt-10" data-aos="fade-up" data-aos-duration="1500" data-aos-delay='1000'>
